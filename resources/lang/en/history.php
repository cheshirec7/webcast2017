...
return [
    ...
    */
    ...
    'backend' => [
        ...
        'racers' => [
            'created' => 'created rider',
            'deleted' => 'deleted rider',
            'updated' => 'updated rider',
        ],

        'checkpoints' => [
            'created' => 'created checkpoint',
            'deleted' => 'deleted checkpoint',
            'updated' => 'updated checkpoint',
        ],

        'scodes' => [
            'created' => 'created status code',
            'deleted' => 'deleted status code',
            'updated' => 'updated status code',
        ],
