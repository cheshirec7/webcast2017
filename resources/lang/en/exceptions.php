    ...
    */
    ...
    'backend' => [
        'access' => [
            ...
            'racers' => [
                'already_exists'    => 'That rider already exists. Please choose a different name.',
                'create_error'      => 'There was a problem creating this rider. Please try again.',
                'delete_error'      => 'There was a problem deleting this rider. Please try again.',
                'not_found'         => 'That rider does not exist.',
                'update_error'      => 'There was a problem updating this rider. Please try again.',
            ],

            'checkpoints' => [
                'already_exists'    => 'That checkpoint already exists. Please choose a different name.',
                'create_error'      => 'There was a problem creating this checkpoint. Please try again.',
                'delete_error'      => 'There was a problem deleting this checkpoint. Please try again.',
                'not_found'         => 'That checkpoint does not exist.',
                'update_error'      => 'There was a problem updating this checkpoint. Please try again.',
            ],

            'scodes' => [
                'already_exists'    => 'That status code already exists. Please choose a different name.',
                'create_error'      => 'There was a problem creating this status code. Please try again.',
                'delete_error'      => 'There was a problem deleting this status code. Please try again.',
                'not_found'         => 'That status code does not exist.',
                'update_error'      => 'There was a problem updating this status code. Please try again.',
            ],
