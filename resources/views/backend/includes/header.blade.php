<header class="main-header">
    {{--<a href="{!! route('frontend.index') !!}" class="logo">--}}
        ...
        {{--<span class="logo-mini"><img style="height: 100%;max-height:25px;" src="/img/favicon32.png" alt="logo"></span>--}}
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div style="color:#fff;font-size:20px;margin-top:10px">&nbsp;2017 Tevis Cup Timing Manager</div>
