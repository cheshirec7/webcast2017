            ...
            <div class="box-body">
                ...
                <div class="form-group" style="display:none;">
                    ...
                    <div class="col-lg-10">
                        @if ($role->id != 1)
                            ...
                            {!! Form::select('associated-permissions', ['custom' => 'Custom'], 'custom', ['class' => 'form-control']) !!}
                        @else
                                ...
                                <div class="col-xs-12">
                                    @if ($permissions->count())
                                        @foreach ($permissions as $perm)
                                            <input type="checkbox" name="permissions[{!! $perm->id !!}]" value="{!! $perm->id !!}" id="perm_{!! $perm->id !!}" checked /> <label for="perm_{!! $perm->id !!}">{!! $perm->display_name !!}</label><br/>
                                        @endforeach
                                    @else
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        ...
                        {!! Form::select('sort', $checkpoints, $role->sort, ['class' => 'form-control']) !!}
                    </div><!--col-lg-10-->
                </div><!--form control-->
            </div><!-- /.box-body -->
        </div><!--box-->
