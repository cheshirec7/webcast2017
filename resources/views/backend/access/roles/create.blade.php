        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                ...
                <div class="form-group" style="display: none;">
                    ...
                    <div class="col-lg-10">
                        {!! Form::select('associated-permissions', array('all' => trans('labels.general.all'), 'custom' => trans('labels.general.custom')), 'custom', ['class' => 'form-control']) !!}
...
{{--                                            {!! is_array(old('permissions')) && in_array($perm->id, old('permissions')) ?--}}
                                            <input type="checkbox" name="permissions[{!! $perm->id !!}]" value="{!! $perm->id !!}" id="perm_{!! $perm->id !!}" checked/>
