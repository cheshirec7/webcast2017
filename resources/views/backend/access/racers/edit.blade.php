...
@section ('title', trans('labels.backend.access.racers.management') . ' | ' . trans('labels.backend.access.racers.edit'))

@section('page-header')
    <h1>
        {!! trans('labels.backend.access.racers.management') !!}
        <small>{!! trans('labels.backend.access.racers.edit') !!}</small>
    </h1>
@endsection

@section('content')
    {!! Form::model($racer, ['route' => ['admin.access.racer.update', $racer], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-racer']) !!}

    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{!! trans('labels.backend.access.racers.edit') !!}</h3>
